...
public class SerialPortException extends Exception {
     ...
     * @since 0.9.0
     */
    final public static String TYPE_PORT_BUSY = "Puerto ocupado";
    /**
     * @since 0.9.0
     */
    final public static String TYPE_PORT_NOT_FOUND = "Puerto no encontrado";
    /**
     * @since 2.2.0
     */
    final public static String TYPE_PERMISSION_DENIED = "Permiso denegado";
    /**
     * @since 2.3.0
     */
    final public static String TYPE_INCORRECT_SERIAL_PORT = "Puerto Serie incorrecto";
